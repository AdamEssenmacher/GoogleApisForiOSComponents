...
Artifact FIREBASE_AB_TESTING_ARTIFACT              = new Artifact ("Firebase.ABTesting",              "11.10.0.1",  "13.0", ComponentGroup.Firebase, csprojName: "ABTesting");
Artifact FIREBASE_ANALYTICS_ARTIFACT               = new Artifact ("Firebase.Analytics",              "11.10.0.1",  "13.0", ComponentGroup.Firebase, csprojName: "Analytics");
Artifact FIREBASE_AUTH_ARTIFACT                    = new Artifact ("Firebase.Auth",                   "11.10.0.1",  "13.0", ComponentGroup.Firebase, csprojName: "Auth");
Artifact FIREBASE_CLOUD_FIRESTORE_ARTIFACT         = new Artifact ("Firebase.CloudFirestore",         "11.10.0.1",  "13.0", ComponentGroup.Firebase, csprojName: "CloudFirestore");
Artifact FIREBASE_CLOUD_FUNCTIONS_ARTIFACT         = new Artifact ("Firebase.CloudFunctions",         "11.10.0.1",  "13.0", ComponentGroup.Firebase, csprojName: "CloudFunctions");
Artifact FIREBASE_CLOUD_MESSAGING_ARTIFACT         = new Artifact ("Firebase.CloudMessaging",         "11.10.0.1",  "13.0", ComponentGroup.Firebase, csprojName: "CloudMessaging");
Artifact FIREBASE_CORE_ARTIFACT                    = new Artifact ("Firebase.Core",                   "11.10.0.1",  "13.0", ComponentGroup.Firebase, csprojName: "Core");
Artifact FIREBASE_CRASHLYTICS_ARTIFACT             = new Artifact ("Firebase.Crashlytics",            "11.10.0.1",  "13.0", ComponentGroup.Firebase, csprojName: "Crashlytics");
Artifact FIREBASE_DATABASE_ARTIFACT                = new Artifact ("Firebase.Database",               "11.10.0.1",  "13.0", ComponentGroup.Firebase, csprojName: "Database");
Artifact FIREBASE_DYNAMIC_LINKS_ARTIFACT           = new Artifact ("Firebase.DynamicLinks",           "11.10.0.1",  "13.0", ComponentGroup.Firebase, csprojName: "DynamicLinks");
...
Artifact FIREBASE_INSTALLATIONS_ARTIFACT           = new Artifact ("Firebase.Installations",          "11.10.0.1",  "13.0", ComponentGroup.Firebase, csprojName: "Installations");
...
Artifact FIREBASE_REMOTE_CONFIG_ARTIFACT           = new Artifact ("Firebase.RemoteConfig",           "11.10.0.1",  "13.0", ComponentGroup.Firebase, csprojName: "RemoteConfig");
Artifact FIREBASE_STORAGE_ARTIFACT                 = new Artifact ("Firebase.Storage",                "11.10.0.1",  "13.0", ComponentGroup.Firebase, csprojName: "Storage");
...
Artifact GOOGLE_MAPS_ARTIFACT                      = new Artifact ("Google.Maps",                     "9.2.0.6",   "15.0", ComponentGroup.Google, csprojName: "Maps");
...
Artifact GOOGLE_PLACES_ARTIFACT                    = new Artifact ("Google.Places",                   "7.4.0.0",   "13.0", ComponentGroup.Google, csprojName: "Places");
Artifact GOOGLE_SIGN_IN_ARTIFACT                   = new Artifact ("Google.SignIn",                   "8.0.0.1",   "12.0", ComponentGroup.Google, csprojName: "SignIn");
...
Artifact GOOGLE_GOOGLE_APP_MEASUREMENT_ARTIFACT    = new Artifact ("Google.AppMeasurement",           "11.10.0.1",   "12.0", ComponentGroup.Google, csprojName: "GoogleAppMeasurement");
Artifact GOOGLE_PROMISES_OBJC_ARTIFACT             = new Artifact ("Google.PromisesObjC",             "2.4.0.1",     "10.0", ComponentGroup.Google, csprojName: "PromisesObjC");
Artifact GOOGLE_GTM_SESSION_FETCHER_ARTIFACT       = new Artifact ("Google.GTMSessionFetcher",        "3.5.0.1",     "13.0", ComponentGroup.Google, csprojName: "GTMSessionFetcher");
Artifact GOOGLE_NANOPB_ARTIFACT                    = new Artifact ("Google.Nanopb",                   "3.30910.0.1", "12.0", ComponentGroup.Google, csprojName: "Nanopb");
Artifact GOOGLE_GOOGLE_UTILITIES_ARTIFACT          = new Artifact ("Google.GoogleUtilities",          "8.0.2.1",     "12.0", ComponentGroup.Google, csprojName: "GoogleUtilities");
Artifact GOOGLE_GOOGLE_DATA_TRANSPORT_ARTIFACT     = new Artifact ("Google.GoogleDataTransport",      "10.1.0.1",    "12.0", ComponentGroup.Google, csprojName: "GoogleDataTransport");

// MLKit artifacts available to be built. These artifacts generate NuGets.
Artifact MLKIT_CORE_ARTIFACT                     = new Artifact ("MLKit.Core",                        "12.0.0.1",  "16.0", ComponentGroup.MLKit, csprojName: "Core");
...
Artifact MLKIT_BARCODE_SCANNING                  = new Artifact ("MLKit.BarcodeScanning",             "6.0.0.1",   "16.0", ComponentGroup.MLKit, csprojName: "BarcodeScanning");

...
//Artifact FIREBASE_APP_DISTRIBUTION_ARTIFACT      = new Artifact ("Firebase.AppDistribution",        "8.10.0",  "15.0", ComponentGroup.Firebase, csprojName: "AppDistribution");
//Artifact FIREBASE_APP_CHECK_ARTIFACT             = new Artifact ("Firebase.AppCheck",               "8.10.0",  "15.0", ComponentGroup.Firebase, csprojName: "AppCheck");

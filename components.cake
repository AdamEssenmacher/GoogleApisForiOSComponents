...
Artifact MLKIT_CORE_ARTIFACT                     = new Artifact ("MLKit.Core",                        "12.0.0.4",  "16.0", ComponentGroup.MLKit, csprojName: "Core");
...
Artifact MLKIT_BARCODE_SCANNING                  = new Artifact ("MLKit.BarcodeScanning",             "6.0.0.4",   "16.0", ComponentGroup.MLKit, csprojName: "BarcodeScanning");

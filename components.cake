...
Artifact MLKIT_CORE_ARTIFACT                     = new Artifact ("MLKit.Core",                        "11.0.0-alpha1",   "12.0", ComponentGroup.MLKit, csprojName: "Core");
...
Artifact MLKIT_BARCODE_SCANNING                  = new Artifact ("MLKit.BarcodeScanning",             "5.0.0-alpha1",    "12.0", ComponentGroup.MLKit, csprojName: "BarcodeScanning");
...
void SetArtifactsPodSpecs ()
{
	...
	MLKIT_CORE_ARTIFACT.PodSpecs = new [] { 
		PodSpec.Create ("MLKitCore",                       "11.0.0"),

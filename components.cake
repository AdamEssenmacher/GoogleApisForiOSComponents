...
Artifact FIREBASE_AB_TESTING_ARTIFACT              = new Artifact ("Firebase.ABTesting",              "11.14.0.0",  "13.0", ComponentGroup.Firebase, csprojName: "ABTesting");
Artifact FIREBASE_ANALYTICS_ARTIFACT               = new Artifact ("Firebase.Analytics",              "11.14.0.0",  "13.0", ComponentGroup.Firebase, csprojName: "Analytics");
Artifact FIREBASE_AUTH_ARTIFACT                    = new Artifact ("Firebase.Auth",                   "11.14.0.0",  "13.0", ComponentGroup.Firebase, csprojName: "Auth");
Artifact FIREBASE_CLOUD_FIRESTORE_ARTIFACT         = new Artifact ("Firebase.CloudFirestore",         "11.14.0.0",  "13.0", ComponentGroup.Firebase, csprojName: "CloudFirestore");
Artifact FIREBASE_CLOUD_FUNCTIONS_ARTIFACT         = new Artifact ("Firebase.CloudFunctions",         "11.14.0.0",  "13.0", ComponentGroup.Firebase, csprojName: "CloudFunctions");
Artifact FIREBASE_CLOUD_MESSAGING_ARTIFACT         = new Artifact ("Firebase.CloudMessaging",         "11.14.0.0",  "13.0", ComponentGroup.Firebase, csprojName: "CloudMessaging");
Artifact FIREBASE_CORE_ARTIFACT                    = new Artifact ("Firebase.Core",                   "11.14.0.0",  "13.0", ComponentGroup.Firebase, csprojName: "Core");
Artifact FIREBASE_CRASHLYTICS_ARTIFACT             = new Artifact ("Firebase.Crashlytics",            "11.14.0.0",  "13.0", ComponentGroup.Firebase, csprojName: "Crashlytics");
Artifact FIREBASE_DATABASE_ARTIFACT                = new Artifact ("Firebase.Database",               "11.14.0.0",  "13.0", ComponentGroup.Firebase, csprojName: "Database");
Artifact FIREBASE_DYNAMIC_LINKS_ARTIFACT           = new Artifact ("Firebase.DynamicLinks",           "11.14.0.0",  "13.0", ComponentGroup.Firebase, csprojName: "DynamicLinks");
...
Artifact FIREBASE_INSTALLATIONS_ARTIFACT           = new Artifact ("Firebase.Installations",          "11.14.0.0",  "13.0", ComponentGroup.Firebase, csprojName: "Installations");
...
Artifact FIREBASE_REMOTE_CONFIG_ARTIFACT           = new Artifact ("Firebase.RemoteConfig",           "11.14.0.0",  "13.0", ComponentGroup.Firebase, csprojName: "RemoteConfig");
Artifact FIREBASE_STORAGE_ARTIFACT                 = new Artifact ("Firebase.Storage",                "11.14.0.0",  "13.0", ComponentGroup.Firebase, csprojName: "Storage");
...
Artifact GOOGLE_GOOGLE_APP_MEASUREMENT_ARTIFACT    = new Artifact ("Google.AppMeasurement",           "11.14.0.0",   "12.0", ComponentGroup.Google, csprojName: "GoogleAppMeasurement");
...
void SetArtifactsPodSpecs ()
{
	...
	FIREBASE_AB_TESTING_ARTIFACT.PodSpecs = new [] { 
		PodSpec.Create ("FirebaseABTesting", "11.14.0", frameworkSource: FrameworkSource.Pods)
	};
	FIREBASE_ANALYTICS_ARTIFACT.PodSpecs = new [] {
		PodSpec.Create ("FirebaseAnalytics", "11.14.0")
	};
	FIREBASE_AUTH_ARTIFACT.PodSpecs = new [] {
		PodSpec.Create ("FirebaseAuth",     "11.14.0", frameworkSource: FrameworkSource.Pods),
	...
	FIREBASE_CLOUD_FIRESTORE_ARTIFACT.PodSpecs = new [] {
		PodSpec.Create ("FirebaseFirestore",         "11.14.0",       frameworkSource: FrameworkSource.Pods),
		PodSpec.Create ("FirebaseFirestoreInternal", "11.14.0",       frameworkSource: FrameworkSource.Pods),
	...
	FIREBASE_CLOUD_FUNCTIONS_ARTIFACT.PodSpecs = new [] {
		PodSpec.Create ("FirebaseFunctions", "11.14.0", frameworkSource: FrameworkSource.Pods)		
	};
	FIREBASE_CLOUD_MESSAGING_ARTIFACT.PodSpecs = new [] {
		PodSpec.Create ("FirebaseMessaging", "11.14.0", frameworkSource: FrameworkSource.Pods)		
	};
	FIREBASE_CORE_ARTIFACT.PodSpecs = new [] {
	    PodSpec.Create ("FirebaseAppCheckInterop",     "11.14.0", frameworkSource: FrameworkSource.Pods),
	    PodSpec.Create ("FirebaseAuthInterop",         "11.14.0", frameworkSource: FrameworkSource.Pods),
		PodSpec.Create ("FirebaseCore",                "11.14.0", frameworkSource: FrameworkSource.Pods),		
		PodSpec.Create ("FirebaseCoreExtension",       "11.14.0", frameworkSource: FrameworkSource.Pods),
		PodSpec.Create ("FirebaseCoreInternal",        "11.14.0", frameworkSource: FrameworkSource.Pods),
		PodSpec.Create ("FirebaseMessagingInterop",    "11.14.0", frameworkSource: FrameworkSource.Pods),
		PodSpec.Create ("FirebaseRemoteConfigInterop", "11.14.0", frameworkSource: FrameworkSource.Pods),
		PodSpec.Create ("FirebaseSessions",            "11.14.0", frameworkSource: FrameworkSource.Pods),
		PodSpec.Create ("FirebaseSharedSwift",         "11.14.0", frameworkSource: FrameworkSource.Pods),
		PodSpec.Create ("GoogleAppMeasurement",        "11.14.0"),
	...
	FIREBASE_CRASHLYTICS_ARTIFACT.PodSpecs = new [] {
		PodSpec.Create ("FirebaseCrashlytics", "11.14.0", frameworkSource: FrameworkSource.Pods)
	};
	FIREBASE_DATABASE_ARTIFACT.PodSpecs = new [] {
		PodSpec.Create ("FirebaseDatabase", "11.14.0", frameworkSource: FrameworkSource.Pods)		
	};
	FIREBASE_DYNAMIC_LINKS_ARTIFACT.PodSpecs = new [] {
		PodSpec.Create ("FirebaseDynamicLinks", "11.14.0", frameworkSource: FrameworkSource.Pods)
	};
	...
	FIREBASE_INSTALLATIONS_ARTIFACT.PodSpecs = new [] {
		PodSpec.Create ("FirebaseInstallations", "11.14.0", frameworkSource: FrameworkSource.Pods)
	};
	...
	FIREBASE_REMOTE_CONFIG_ARTIFACT.PodSpecs = new [] {
		PodSpec.Create ("FirebaseRemoteConfig", "11.14.0", frameworkSource: FrameworkSource.Pods)
	};
	FIREBASE_STORAGE_ARTIFACT.PodSpecs = new [] {
		PodSpec.Create ("FirebaseStorage", "11.14.0", frameworkSource: FrameworkSource.Pods)
	};

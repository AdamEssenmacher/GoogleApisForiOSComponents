...
.NET bindings for Firebase Realtime Database on Apple platforms.

## Scope

Realtime Database app, reference, query, snapshot, server value, transaction, persistence, and emulator APIs exposed by the Firebase Apple SDK.
...
- Package ID: `AdamE.Firebase.iOS.Database`
- Managed namespace: `Firebase.Database`
...
<ItemGroup Condition="$([MSBuild]::GetTargetPlatformIdentifier('$(TargetFramework)')) == 'ios' Or $([MSBuild]::GetTargetPlatformIdentifier('$(TargetFramework)')) == 'maccatalyst'">
  <PackageReference Include="AdamE.Firebase.iOS.Database" Version="x.y.z" />
</ItemGroup>
```

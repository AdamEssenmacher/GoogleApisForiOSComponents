...
.NET bindings for Firebase Cloud Functions on Apple platforms.

## Scope

HTTPS callable function, callable options, emulator, result, and error APIs exposed by the Firebase Apple SDK.
...
- Package ID: `AdamE.Firebase.iOS.CloudFunctions`
- Managed namespace: `Firebase.CloudFunctions`
...
<ItemGroup Condition="$([MSBuild]::GetTargetPlatformIdentifier('$(TargetFramework)')) == 'ios' Or $([MSBuild]::GetTargetPlatformIdentifier('$(TargetFramework)')) == 'maccatalyst'">
  <PackageReference Include="AdamE.Firebase.iOS.CloudFunctions" Version="x.y.z" />
</ItemGroup>
```

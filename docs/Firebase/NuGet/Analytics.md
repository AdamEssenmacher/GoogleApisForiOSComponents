...
.NET bindings for Firebase Analytics on Apple platforms.

## Scope

Analytics event, user property, consent, session, and conversion APIs exposed by the Firebase Apple SDK.
...
<ItemGroup Condition="$([MSBuild]::GetTargetPlatformIdentifier('$(TargetFramework)')) == 'ios' Or $([MSBuild]::GetTargetPlatformIdentifier('$(TargetFramework)')) == 'maccatalyst'">
  <PackageReference Include="AdamE.Firebase.iOS.Analytics" Version="x.y.z" />
</ItemGroup>
```

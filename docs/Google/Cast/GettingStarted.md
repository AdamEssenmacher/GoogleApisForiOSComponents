...
This path is retained for existing links, but this repository does not maintain a copied Google Cast walkthrough.
...
- Google Cast documentation: https://developers.google.com/cast/docs/ios_sender

## Binding Project

- Package ID: `AdamE.Google.iOS.Cast`
